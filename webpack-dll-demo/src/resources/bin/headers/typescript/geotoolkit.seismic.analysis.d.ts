        ...
        module analysis {
            ...
            module filters {
                ...
                class TaperFilterProcess extends geotoolkit.seismic.pipeline.processor.SeismicTraceProcessor {
                     ...
                     * @param state.name  (Optional) name of the process
                     * @param state.apply  (Optional) process activated or not.
                     * @param state.sampleRate  (Optional) The sample rate
                     * @param state.passFlag  (Optional) filtering mode
                     * @param state.f1  (Optional) 1st frequency
                     * @param state.f2  (Optional) 2nd frequency
                     * @param state.f3  (Optional) 3rd frequency
                     * @param state.f4  (Optional) 4th frequency
                     */
