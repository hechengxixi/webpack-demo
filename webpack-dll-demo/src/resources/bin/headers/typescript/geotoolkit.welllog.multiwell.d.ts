...
If tracks are created and it is changed from 'none' to true then it doesn't rebuild footers for existing tracks
                 ...
                 * @param alignment  (Optional) vertical alignment of track according to container visible limits. alignment value is "top", "bottom", "center"
                 */
                alignToMarker(name: string|Function, alignment?: string): this;
                /**
                 * Pans to the point
                 * @param x  (Required) X coordinate of point to pan in track container model coordinate
                 * @param y  (Required) Y coordinate of point to pan in track container model coordinate
                 * @param alignment  (Optional) alignment of specified point according to container
visible limits.
                 */
                panTo(x: number, y: number, alignment?: string|geotoolkit.util.AnchorType): this;
                /**
                 ...
                 * @param offset  (Optional) offset in container coordinates
                 */
                alignTracks(offset?: number): this;
                /**
            ...
            interface IWellTrack {
                 ...
                 * @param fromIndex  (Required) start depth or depth range
                 * @param toIndex  (Optional) end range or option to fit to container visible limits
                 * @param fitHeight  (Optional) option to fit to container visible limits
                 */
                setVisibleDepthLimits(fromIndex: number|geotoolkit.util.Range, toIndex?: number|boolean, fitHeight?: boolean): this;
                /**
                 * Returns data source
                 */
                getData(): geotoolkit.data.DataSource;
            ...
            module tools {
                ...
                class CorrelationCursor extends geotoolkit.controls.tools.AbstractTool {
                     ...
                     * @param options.multiwell  (Optional) multi-well widget
