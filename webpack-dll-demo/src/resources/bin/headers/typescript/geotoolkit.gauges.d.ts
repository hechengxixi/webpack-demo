...
preservation of aspect ratio.
        ...
        module layout {
            ...
            class Region {
                 ...
                 * Sets properties pertaining to this object
                 * @param params  (Required) JSON with properties
                 * @param params.bounds  (Optional) region bounds
                 * @param params.name  (Optional) region name
                 * @param params.padding  (Optional) padding
                 * @param params.fillstyle  (Optional) region fillstyle
                 * @param params.linestyle  (Optional) region border linestyle
                 */
            ...
            class GaugeLayout extends geotoolkit.layout.Layout {
                 ...
                 * @param params.x  (Optional) X of the region relative to its parent
                 * @param params.y  (Optional) Y of the region relative to its parent
                 * @param params.width  (Optional) Width of the region relative to its parent
                 * @param params.height  (Optional) Height of the region relative to its parent
                 */
