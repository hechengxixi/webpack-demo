...
stored in micro-seconds.
            ...
            class SeismicData extends geotoolkit.util.EventDispatcher {
                 ...
                 * @param callback  (Required) callback to be called then section is loaded. This method has {geotoolkit.seismic.data.QueryResult}
as parameter
                 */
...
supported now
            ...
            class RemoteSeismicReader extends geotoolkit.seismic.data.SeismicReader {
                 ...
                 * @param query.to  (Optional) specify end trace index from 0 to getTraceNumbers()-1
                 * @param query.traceIndexes  (Optional) optional indices of traces from 0 to getTraceNumbers()-1
                 * @param callback  (Required) callback to be called then section is loaded.
                 */
                select(query: any | { headers?: boolean; samples?: boolean; from?: number; to?: number; traceIndexes?: number[]; } , callback: Function): any;
                /**
            ...
            class RemoteSeismicDataSource {
                 ...
                 * @param options.requestheaders  (Optional) HTTP request headers as key-value pair. it it is specified then it will be applied
                 */
...
ignored for XSection queries. A trace order of 2 indicates a Map query. The Time key is required for Map queries, with identical min and max values (a time slice).
            ...
            module compression {
                ...
                class Decompress {
                     ...
                     * @param data  (Required) The seismic data that will be decompressed.
                     */
...
samples
                 ...
                 * @param normalization.type  (Optional) enum of normalization types
                 * @param normalization.limits  (Optional) normalization limits (min,max)
                 * @param normalization.scale  (Optional) scale factor
                 */
            ...
            module processor {
                ...
                class SeismicTraceProcessor {
                     ...
                     * @param state.name  (Optional) name of the processor
                     * @param state.apply  (Optional) whether the processor is active or not.
                     */
                ...
                class Reverse extends geotoolkit.seismic.pipeline.processor.SeismicTraceProcessor {
                     ...
                     * @param state.name  (Optional) the name of the processor
                     * @param state.apply  (Optional) to apply the process or not.
                     * @param state.reversed  (Optional) reversed trace values or not
                     * @param state.inverted  (Optional) invert polarity or not. Specifies if the polarity is +ve or -ve
                     */
                     ...
                     * @param state.reversed  (Optional) specifies if the baseline of the trace is reversed or not
                     * @param state.inverted  (Optional) specifies if the polarity is +ve or -ve
                     */
                ...
                class AGC extends geotoolkit.seismic.pipeline.processor.SeismicTraceProcessor {
                     ...
                     * AGC is commonly used to improve visibility of late-arriving events.
                     * </p>
                     * @param state  (Optional) of the data filter
                     * @param state.apply  (Optional) process activated or not.
                     * @param state.desiredAverage  (Optional) desired average amplitude
                     * @param state.units  (Optional) enum of AGC units
                     * @param state.windowLength  (Optional) the AGC window size
                     * @param state.agcLength  (Optional) AGC length
                     * @param state.startSample  (Optional) start smaple to start the AGC process
                     * @param state.step  (Optional) step
                     */
        ...
        module axis {
            ...
            class IndexTickGenerator extends geotoolkit.axis.TickGenerator {
                /**
                 * Defines a simple tick generator for seismic axis. This tick generator is specialized to display ticks for seismic shapes.
                 * @param pipeline  (Optional) seismic pipeline
                 */
                constructor(pipeline?: geotoolkit.seismic.pipeline.SeismicPipeline);
                /**
