...
declare module geotoolkit {
    module widgets {
        ...
        class AnnotatedWidget extends geotoolkit.widgets.BaseWidget implements geotoolkit.scene.exports.IExportable {
             ...
             * @param options.border  (Optional) defines properties for widget model area outer border {@link geotoolkit.attributes.LineStyle}
             */
            constructor(options?: any | { model?: geotoolkit.scene.Group; bounds?: geotoolkit.util.Rect; north?: any | { size?: number|string; title?: any; axis?: any; } ; east?: any; south?: any; west?: any; annotationitemswrap?: boolean; annotationssizes?: any | { east?: number|string; south?: number|string; west?: number|string; north?: number|string; } ; tools?: any; border?: geotoolkit.attributes.LineStyle|any|string; } );
            /**
...
For details, see the internalAddAxis method.
             ...
             * @param location  (Required) location of annotation that containing axis for the group
             */
        ...
        class TimeSeriesWidget extends geotoolkit.widgets.BaseWidget {
             ...
             * @param options.curveid  (Optional) curve id to match the poi
             * @param options.time  (Optional) time index in model space
...
all listeners
                 ...
                 * @param data  (Required) data
                 * @param data.vertical  (Optional) data in the vertical direction
                 * @param data.horizontal  (Optional) data in horizontal direction
        ...
        module timeseries {
            ...
            class TimeSeriesObject extends geotoolkit.widgets.timeseries.TimeSeriesObjectBase {
                 ...
                 * @param options.name  (Optional) Object/curve's name
                 * @param options.curve  (Optional) curve properties
                 * @param options.curve.data  (Optional) 
        ...
        module tools {
            ...
            class InPlaceEditor extends geotoolkit.controls.tools.AbstractTool {
                 ...
                 * @param cell.row  (Optional) row
                 * @param cell.column  (Optional) column
                 */
