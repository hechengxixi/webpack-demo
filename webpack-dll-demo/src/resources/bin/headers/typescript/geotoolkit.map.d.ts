...
this AbstractSystem (approximately)
        ...
        module features {
            ...
            class AbstractFeature implements geotoolkit.map.features.IFeature {
                 ...
                 * @param options.id  (Optional) ID
                 * @param options.attributes  (Optional) attributes (non-spatial properties)
                 */
                constructor(options: any | { geometry: any|any[]; id?: number|string; attributes?: any; } );
                /**
                 * Gets ID
                 */
                getId(): number|string;
            ...
            class Point extends geotoolkit.map.features.AbstractFeature {
                 ...
                 */
                constructor(options: any | { geometry: any | { x: number; y: number; } ; } );
                /**
                 * Applies Map coordinate system to itself
                 * @param layer  (Required) map layer to use for coordinate system conversion
                 */
            ...
            class MultiPoint extends geotoolkit.map.features.AbstractFeature {
                 ...
                 */
                constructor(options: any | { geometry: any[]; } );
                /**
                 * Applies Map coordinate system to itself
                 * @param layer  (Required) map layer to use for coordinate system conversion
                 */
            ...
            class Aggregation extends geotoolkit.map.features.Point {
                 ...
                 */
                constructor(options: any | { aggregation?: geotoolkit.util.Iterator; } );
                /**
...
(see {@link geotoolkit.scene.shapes.Text} constructor JSON-object for details)
            ...
            module adapters {
                ...
                class Center implements geotoolkit.map.features.adapters.IGeometryToText {
                     ...
                     * @param context  (Optional) rendering context or its transformation
                     */
                    apply(geometry: any | { x: number[]; y: number[]; } , text: geotoolkit.scene.shapes.Text, context?: geotoolkit.renderer.RenderingContext|geotoolkit.util.Transformation): any;
                }
                /**
                ...
                class LineString implements geotoolkit.map.features.adapters.IGeometryToShape {
                     ...
                     * @param context  (Optional) rendering context or its transformation
                     */
                    apply(geometry: any | { x: number[]; y: number[]; } , polyline: geotoolkit.scene.shapes.Polyline, context?: geotoolkit.renderer.RenderingContext|geotoolkit.util.Transformation): any;
                }
                /**
                 * Applies feature geometry's 'x' and 'y' coordinates (in Map C.S.) to {@link geotoolkit.scene.shapes.Polygon}
                 */
                class Polygon implements geotoolkit.map.features.adapters.IGeometryToShape {
                     ...
                     * @param context  (Optional) rendering context or its transformation
                     */
                    apply(geometry: any | { x: number[]; y: number[]; } , polygon: geotoolkit.scene.shapes.Polygon, context?: geotoolkit.renderer.RenderingContext|geotoolkit.util.Transformation): any;
                }
                /**
                ...
                class Path implements geotoolkit.map.features.adapters.IGeometryToShape {
                     ...
                     * @param context  (Optional) rendering context or its transformation
                     */
                    apply(geometry: any | { x: number[]; y: number[]; } , path: geotoolkit.scene.Node, context?: geotoolkit.renderer.RenderingContext|geotoolkit.util.Transformation): any;
                }
                /**
                 * Interface to retrieve feature geometry and apply it to {@link geotoolkit.scene.Node} shape
                 */
                interface IGeometryToShape {
                     ...
                     * @param context  (Optional) rendering context or its transformation
                     */
                    apply(geometry: any, shape: geotoolkit.scene.Node, context?: geotoolkit.renderer.RenderingContext|geotoolkit.util.Transformation): any;
                }
                /**
                ...
                interface IGeometryToText {
                     ...
                     * @param context  (Optional) rendering context or its transformation
                     */
                    apply(geometry: any, shape: geotoolkit.scene.shapes.Text, context?: geotoolkit.renderer.RenderingContext|geotoolkit.util.Transformation): any;
                }
                module Center {
                    /**
                     * Enum for GeometryToText modes
...
expanded aggregation level (0 for root, 1 for its children, etc.)
        ...
        module util {
            ...
            class Geometry {
                 ...
                 */
                static getCachedGeometryBounds(geometry: any | { x: number|number[]; y: number|number[]; } ): geotoolkit.util.Rect;
                /**
