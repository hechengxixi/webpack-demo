...
width and height will be set to that number
        ...
        module shapes {
            ...
            class Histogram extends geotoolkit.scene.shapes.Shape {
                 ...
                 * @param options.data  (Optional) data array
            ...
            class LineChart extends geotoolkit.scene.Group implements geotoolkit.controls.shapes.IChartDataVisual {
                 ...
                 * @param x.x  (Optional) array of X coordinates
...
parameters are ignored
            ...
            class RoseChart extends geotoolkit.scene.shapes.Shape {
                 ...
                 * @param data.name  (Optional) name of the rose chart diagram
            ...
            class BarChart extends geotoolkit.scene.Group {
                 ...
                 * @param options.barmaxwidth  (Optional) maximum width of bar in device space
...
true then method dispose is called for each child.
        ...
        module tools {
            ...
            class CrossHair extends geotoolkit.controls.tools.AbstractTool {
                 ...
                 * @param settings.enabled  (Optional) tool is enabled
                 * @param settings.linestyle  (Optional) Linestyle for both lines
                 * @param settings.horizontal  (Optional) Linestyle for horizontal line
                 * @param settings.vertical  (Optional) Linestyle for vertical line
                 * @param settings.north  (Optional) JSON for north label. See setLabelSettings for more details
                 * @param settings.south  (Optional) JSON for south label. See setLabelSettings for more details
                 * @param settings.east  (Optional) JSON for east label. See setLabelSettings for more details
                 * @param settings.west  (Optional) JSON for west label. See setLabelSettings for more details
                 * @param settings.center  (Optional) JSON for center label. See setLabelSettings for more details
...
WARNING: if you set positive inertia coefficient, some panning events'll be fired with null eventArgs
            ...
            module treemap {
                ...
                class TreemapLevelTool extends geotoolkit.controls.tools.AbstractTool {
                     ...
                     * @param options.group  (Optional) manipulator layer
                     * @param options.name  (Optional) name of the tool
                     * @param options.chart  (Required) chart shape
            ...
            module scroll {
                ...
                class AbstractScroll extends geotoolkit.scene.Group {
                     ...
                     *  <br>
                     * @param options  (Optional) 
                     * @param options.name  (Optional) scroll bar name
                     */
