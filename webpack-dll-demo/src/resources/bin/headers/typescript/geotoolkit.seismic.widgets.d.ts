...
then it is necessary to set up manually model limits for model
                 ...
                 * @param saveViewPoint  (Optional) if true, scale relative to the center visible limits
                 */
                setScaleOptions(scaleOptions: any | { deviceunit?: geotoolkit.util.AbstractUnit|string; sampleunit?: geotoolkit.util.AbstractUnit|string; tracescale?: number; samplescale?: number; } , saveViewPoint?: boolean): this;
                /**
...
visible limits will be intersected with model limits of the seismic
                 ...
                 * @param options.scale.deviceunit  (Optional) physical device unit
                 * @param options.scale.sampleunit  (Optional) sample unit, sample unit from pipeline will be used if not specified
                 * @param options.scale.tracescale  (Optional) in traces per device unit (e.g traces per inch)
                 * @param options.scale.samplescale  (Optional) in z unit per device unit if depth data (e.g feet per inch), or in device unit per z unit (e.g inches per second)
                 */
                setData(options: any | { pipeline?: any | { version?: string; interpolation?: any | { type?: string; } ; normalization?: any | { type?: geotoolkit.seismic.pipeline.SeismicPipeline.NormalizationType; limits?: geotoolkit.util.Range; scale?: number; } ; plot?: any | { type?: string; clippingFactor?: string; decimationSpacing?: string; } ; colors?: any; } ; colors?: any | { colorMap?: string|geotoolkit.seismic.util.SeismicColors; } ; scale?: any | { deviceunit?: geotoolkit.util.AbstractUnit|string; sampleunit?: geotoolkit.util.AbstractUnit|string; tracescale?: number; samplescale?: number; } ; } ): this;
                /**
            ...
            module tools {
                ...
                class Comparator extends geotoolkit.controls.tools.AbstractTool {
                     ...
                     */
                    getOptions(): {options:{width:number;linestyle:geotoolkit.attributes.LineStyle;fillstyle:geotoolkit.attributes.FillStyle}}|any;
                    /**
                     * Set visual options
                     * @param options  (Required) visual options
                     * @param options.width  (Optional) splitter width
                     * @param options.linestyle  (Optional) splitter border line style
                     * @param options.fillstyle  (Optional) splitter fill style
                     */
                    setOptions(options: any | { width?: number; linestyle?: geotoolkit.attributes.LineStyle|any|string; fillstyle?: geotoolkit.attributes.FillStyle|any|string; } ): this;
                    /**
                     * Returns split flag
                     */
                    getSplit(): boolean;
                     ...
                     * @param continuous  (Required) continuous mode flag
                     */
                    ...
                    /**
                     * Set split position
                     * @param position  (Required) splitter position (interval [0, 1])
                     */
