...
object can be in format of constructor of geotoolkit.attributes.LineStyle
        ...
        class LogTadPole extends geotoolkit.welllog.LogCurve {
             ...
             * @param datasource.datasource  (Optional) data source to be displayed
        ...
        class Log2DVisual extends geotoolkit.welllog.LogAbstractVisual {
             ...
             * @param properties.description  (Optional) the description
        ...
        module data {
            ...
            class LogDrillingSection {
                /**
                 * Define container of the drilling sections
                 * @param depthFrom  (Optional) from depth
                 * @param depthTo  (Optional) to depth
                 * @param valueFrom  (Optional) 
                 * @param valueFrom.Break  (Optional) 
                 * @param valueFrom.Date  (Optional) 
                 * @param valueTo  (Optional) 
                 * @param valueTo.Break  (Optional) 
                 * @param valueTo.Date  (Optional) 
...
first "Left-to-right" then "top-to-bottom":
                 ...
                 * @param properties.element  (Optional) element properties
                 * @param properties.element.elementName  (Optional) see {@link geotoolkit.welllog.header.AdaptiveLogVisualHeader#setElement}
                 */
...
object can be in format of constructor of geotoolkit.attributes.LineStyle
            ...
            class StackedTrackHeader extends geotoolkit.welllog.header.LogTrackHeader {
                /**
                 * Define header for  StackedTrack
                 * @param track  (Required) a log track to create header
                 * @param provider  (Optional) provider of the headers
                 * @param trackFactory  (Optional) the factory that is used to create headers
                 */
                constructor(track: geotoolkit.welllog.LogTrack, provider?: geotoolkit.welllog.header.LogVisualHeaderProvider, trackFactory?: geotoolkit.welllog.TrackFactory);
            }
