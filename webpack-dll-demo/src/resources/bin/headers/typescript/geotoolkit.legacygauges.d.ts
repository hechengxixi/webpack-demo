    ...
    module gauges {
        ...
        module knownGauges {
            ...
            class VerticalTrafficGauge extends geotoolkit.gauges.knownGauges.SimpleTrafficGauge {
                 ...
                 * Sets all the properties pertaining to this object
                 * @param properties  (Required) JSON containing the properties to set
                 * @param properties.alarmshapes  (Optional) Array of alarm shapes
                 */
...
Array of geotoolkit.gauges.utils.Range to apply
            ...
            class DoubleCircularGauge extends geotoolkit.gauges.Gauge {
                /**
                 * Defines a Circular Gauge with two values.
                 * @param left  (Optional) X location of the left boundary of the gauge or a JSON with parameters
                 * @param left.left  (Optional) X location of the left boundary of the gauge or a JSON with parameters
                 * @param left.top  (Optional) Y location of the top boundary of the gauge
                 * @param left.right  (Optional) X location of the right boundary of the gauge
                 * @param left.bottom  (Optional) Y location of the bottom boundary of the gauge
                 * @param left.width  (Optional) Width of the gauge
        ...
        module shapes {
            class ColorBarShape extends geotoolkit.scene.Group {
                /**
                 * @param params  (Optional) A JSON with properties
                 * @param params.ranges  (Optional) Ranges that this color bar represents
                 * @param params.orientation  (Optional) Orientation of the color bar
                 * @param params.max  (Optional) Maximum of the range represented by this color bar
                 * @param params.min  (Optional) Minimum of the range represented by this color bar
                 */
                 ...
                 * @param props.ranges  (Optional) Ranges that this color bar represents
                 * @param props.orientation  (Optional) Orientation of the color bar
                 * @param props.max  (Optional) Maximum of the range represented by this color bar
                 * @param props.min  (Optional) Minimum of the range represented by this color bar
                 */
            ...
            class CircularTick extends geotoolkit.gauges.shapes.BaseShape {
                 ...
                 * @param visible  (Required) Set visibility on or off or JSON with parameters
                 * @param visible.visible  (Optional) Set visibility on or off or JSON with parameters
                 * @param visible.type  (Optional) Location of ticks
                 * @param visible.textstyle  (Optional) Style of labels
                 * @param visible.values  (Optional) List of labels to be used - null for automated values
                 * @param type  (Optional) Location of ticks
