 ...
 *
 * @param {object} options options
 * @param {object|object[]} options.geometry geometry
 ...
 *
 * @param {object} options options
 * @param {object[]} options.geometry feature geometry as array of elements where each element is in the format of {@link geotoolkit.map.features.Point}'s geometry
 */
 ...
 * @param {number[]} options.geometry.x array of x-coordinates
 * @param {number[]} options.geometry.y array of y-coordinates
 */
 ...
 * @param {object[]} options.geometry feature geometry as array of elements where each element is in the format of {@link geotoolkit.map.features.LineString}'s geometry
 */
 ...
 *
 * @param {object} options feature options
 * @param {object[]} options.geometry feature geometry as array of elements where each element is in the format of {@link geotoolkit.map.features.Polygon}'s geometry
 */
...
geotoolkit.map.features.adapters.IGeometryToShape = {};
     ...
     */
    geotoolkit.map.features.adapters.IGeometryToShape.prototype.apply = function(geometry, shape, context){};
...
geotoolkit.map.features.adapters.Edge = {};
     ...
     *
     * @param {!object} geometry feature geometry
     * @param {!number[]} geometry.x array of x-ordinates
     * @param {!number[]} geometry.y array of y-ordinates
     * @param {!geotoolkit.scene.shapes.Text} text text shape to set the anchor on
     * @param {geotoolkit.renderer.RenderingContext | geotoolkit.util.Transformation} [context] rendering context or its transformation
     */
...
geotoolkit.map.features.adapters.LineString = {};
     ...
     *
     * @param {!object} geometry feature geometry
     * @param {!number[]} geometry.x x-coordinates
     * @param {!number[]} geometry.y y-coordinates
     * @param {!geotoolkit.scene.shapes.Polyline} polyline polyline to set the coordinates on
     * @param {geotoolkit.renderer.RenderingContext | geotoolkit.util.Transformation} [context] rendering context or its transformation
     */
    geotoolkit.map.features.adapters.LineString.prototype.apply = function(geometry, polyline, context){};
...
geotoolkit.map.features.adapters.Path = {};
     ...
     * @param {geotoolkit.renderer.RenderingContext | geotoolkit.util.Transformation} [context] rendering context or its transformation
     */
    geotoolkit.map.features.adapters.Path.prototype.apply = function(geometry, path, context){};
...
geotoolkit.map.sources.loaders.AbstractLoader = {};
     ...
     * @return {?string}
     */
    geotoolkit.map.sources.loaders.AbstractLoader.prototype.getCopyright = function(){};
...
geotoolkit.map.sources.AbstractSource = {};
     ...
     * @return {?string}
     */
    geotoolkit.map.sources.AbstractSource.prototype.getCopyright = function(){};
...
geotoolkit.map.layers.Shape = {};
     ...
     * @inheritdoc
     */
    geotoolkit.map.layers.Shape.prototype.enumerateNodes = function(){};
    /**
     * @protected
     * @returns {geotoolkit.util.Rect}
     */
     ...
     * @inheritdoc
     */
    geotoolkit.map.layers.Shape.prototype.setMapCoordinateSystem = function(){};
    /**
     ...
     * @inheritdoc
     */
    geotoolkit.map.layers.Shape.prototype.dispose = function(){};
...
geotoolkit.map.util.Geometry = {};
     ...
     *
     * @param {object} geometry feature geometry
     * @param {number|number[]} geometry.x feature geometry x-ordinate(s)
     * @param {number|number[]} geometry.y feature geometry x-ordinate(s)
     * @returns {geotoolkit.util.Rect}
     */
 ...
 *
 * @param {object} options options
 * @param {object[]} options.geometry feature geometry as array of elements where each element is in the format of {@link geotoolkit.map.features.PointMapFeature}'s geometry
 */
 ...
 *
 * @param {object} options feature options
 * @param {object[]} options.geometry feature geometry as array of elements where each element is in the format of {@link geotoolkit.map.features.LineStringMapFeature}'s geometry
 */
 ...
 *
 * @param {object} options feature options
 * @param {object[]} options.geometry feature geometry as array of elements where each element is in the format of {@link geotoolkit.map.features.PolygonMapFeature}'s geometry
 */
