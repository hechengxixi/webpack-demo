...
geotoolkit.welllog.multiwell.IWellTrack = {};
     ...
     * @function
     * @abstract
     * @param {number | geotoolkit.util.Range} fromIndex start depth or depth range
     * @param {number|boolean} [toIndex=false] end range or option to fit to container visible limits
     * @param {boolean} [fitHeight=false] option to fit to container visible limits
     * @example Set visible limits to fit visible area of container
     * well.setVisibleDepthLimits(limits, true);
     * @returns {geotoolkit.welllog.multiwell.IWellTrack}
     */
    geotoolkit.welllog.multiwell.IWellTrack.prototype.setVisibleDepthLimits = function(fromIndex, toIndex, fitHeight){};
    /**
     * Returns data source
     * @function
     * @abstract
...
geotoolkit.welllog.multiwell.MultiWellWidget = {};
     ...
     * @param {string} [alignment="center"] vertical alignment of track according to container visible limits. alignment value is "top", "bottom", "center"
     * @returns {geotoolkit.welllog.multiwell.MultiWellWidget} this
     */
    geotoolkit.welllog.multiwell.MultiWellWidget.prototype.alignToMarker = function(name, alignment){};
    /**
     * Pans to the point
     * @param {number} x X coordinate of point to pan in track container model coordinate
     * @param {number} y Y coordinate of point to pan in track container model coordinate
     * @param {string|geotoolkit.util.AnchorType} [alignment=geotoolkit.util.AnchorType.Center] alignment of specified point according to container
     * visible limits.
     * @returns {geotoolkit.welllog.multiwell.MultiWellWidget}
     */
    geotoolkit.welllog.multiwell.MultiWellWidget.prototype.panTo = function(x, y, alignment){};
    /**
     ...
     * @param {number} [offset=0] offset in container coordinates
     * @returns {geotoolkit.welllog.multiwell.MultiWellWidget} this
     */
    geotoolkit.welllog.multiwell.MultiWellWidget.prototype.alignTracks = function(offset){};
    /**
