 ...
 * @param {object} [options.requestheaders=null] HTTP request headers as key-value pair. it it is specified then it will be applied
 ...
 * @param {geotoolkit.seismic.pipeline.SeismicPipeline} [pipeline=null] seismic pipeline
 */
