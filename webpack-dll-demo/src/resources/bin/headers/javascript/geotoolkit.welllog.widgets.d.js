...
geotoolkit.welllog.widgets.tools.Navigation = {};
    ...
    geotoolkit.welllog.widgets.tools.Navigation.Events = {};
         ...
         * @type {string}
         */
        geotoolkit.welllog.widgets.tools.Navigation.Events.NavigationStart = "";
        /**
         * This events occurs when navigation ends
         * @type {string}
         */
        geotoolkit.welllog.widgets.tools.Navigation.Events.NavigationEnd = "";
    /**
     ...
     * @param {boolean} [options.rangeEdit=true] range edit flag
