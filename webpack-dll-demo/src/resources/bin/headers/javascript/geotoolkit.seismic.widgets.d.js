...
geotoolkit.seismic.widgets.tools.Comparator = {};
     ...
     * @returns {object} [options] JSON containing visual options
     * @returns {number} [options.width] splitter width
     * @returns {geotoolkit.attributes.LineStyle} [options.linestyle] splitter border line style
     * @returns {geotoolkit.attributes.FillStyle} [options.fillstyle] splitter fill style
     */
    geotoolkit.seismic.widgets.tools.Comparator.prototype.getOptions = function(){};
    /**
     * Set visual options
     * @param {object} options visual options
     * @param {number} [options.width=4] splitter width
     * @param {geotoolkit.attributes.LineStyle|object|string} [options.linestyle="rgba(50,50,50,0.8)"] splitter border line style
     * @param {geotoolkit.attributes.FillStyle|object|string} [options.fillstyle="rgba(100,100,100,0.5)"] splitter fill style
     * @returns {geotoolkit.seismic.widgets.tools.Comparator} this
     */
    geotoolkit.seismic.widgets.tools.Comparator.prototype.setOptions = function(options){};
    /**
     * Returns split flag
     * @returns {boolean}
     */
     ...
     * @returns {boolean}
     */
    geotoolkit.seismic.widgets.tools.Comparator.prototype.getContinuous = function(){};
    /**
     * Set continuous mode flag
     * @param {boolean} continuous continuous mode flag
     * @returns {geotoolkit.seismic.widgets.tools.Comparator}
     */
    geotoolkit.seismic.widgets.tools.Comparator.prototype.setContinuous = function(continuous){};
    /**
     * Set orientation
    ...
    /**
     * Set split position
     * @param {number} position splitter position (interval [0, 1])
     * @returns {geotoolkit.seismic.widgets.tools.Comparator} this
     */
...
geotoolkit.seismic.widgets.SeismicViewWidget = {};
     ...
     * @param {boolean} [saveViewPoint] if true, scale relative to the center visible limits
     * @returns {geotoolkit.seismic.widgets.SeismicViewWidget} this
     */
    geotoolkit.seismic.widgets.SeismicViewWidget.prototype.setScaleOptions = function(scaleOptions, saveViewPoint){};
    /**
     ...
     * @param {geotoolkit.util.AbstractUnit|string} [options.scale.deviceunit] physical device unit
     * @param {geotoolkit.util.AbstractUnit|string} [options.scale.sampleunit] sample unit, sample unit from pipeline will be used if not specified
     * @param {number} [options.scale.tracescale] in traces per device unit (e.g traces per inch)
     * @param {number} [options.scale.samplescale] in z unit per device unit if depth data (e.g feet per inch), or in device unit per z unit (e.g inches per second)
     * @returns {geotoolkit.seismic.widgets.SeismicViewWidget}
     */
