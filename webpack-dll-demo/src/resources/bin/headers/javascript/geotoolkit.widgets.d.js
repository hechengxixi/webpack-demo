 ...
 * @param {geotoolkit.attributes.LineStyle|object|string} [options.border] defines properties for widget model area outer border {@link geotoolkit.attributes.LineStyle}
 *
 * @example
