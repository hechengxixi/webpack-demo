...
geotoolkit.welllog.data.ArrayLogAbstractData = {};
     ...
     * @returns {geotoolkit.welllog.data.ArrayLogAbstractData} this
     */
    geotoolkit.welllog.data.ArrayLogAbstractData.prototype.setIndexUnit = function(unit){};
    /**
     * Returns index unit
     * @returns {?geotoolkit.util.AbstractUnit}
     */
    geotoolkit.welllog.data.ArrayLogAbstractData.prototype.getIndexUnit = function(){};
    /**
...
geotoolkit.welllog.Log2DVisual = {};
     ...
     * @inheritdoc
     */
    geotoolkit.welllog.Log2DVisual.prototype.clone = function(){};
    /**
     * @inheritdoc
     */
    geotoolkit.welllog.Log2DVisual.prototype.copyConstructor = function(){};
    /**
     * @inheritdoc
     */
    geotoolkit.welllog.Log2DVisual.prototype.dispose = function(){};
    /**
     ...
     */
    geotoolkit.welllog.Log2DVisual.prototype.setGapFillCutoffValue = function(cutoff){};
    /**
     * Returns the value of the cutoff used for removing NaN valued samples
     * @returns {number} The cutoff value
     */
    geotoolkit.welllog.Log2DVisual.prototype.getGapFillCutoffValue = function(){};
    /**
     * Set the value of the gap. Value will be used to disconnect the sample if the distance between two samples in depth or time is more than specified value
     * @param {number} value The maximum discontinuity allowed in depth or time
     * @returns {geotoolkit.welllog.Log2DVisual} this
     */
    geotoolkit.welllog.Log2DVisual.prototype.setGapValue = function(value){};
    /**
     * Returns The maximum discontinuity allowed in depth or time
     * @returns {number} value
     */
    geotoolkit.welllog.Log2DVisual.prototype.getGapValue = function(){};
    /**
     * Sets the unit of the cutoff used for removing NaN valued samples. Gaps will only be 'filled'
     * when the cutoff value is non zero and the unit is convertible to the index unit. If unit is not specified
     * then curve index unit is used. if a depth or time interval is less than specified cutoff value then interval is connected and NaN
     ...
     * @returns {geotoolkit.welllog.Log2DVisual} this
     */
    geotoolkit.welllog.Log2DVisual.prototype.setGapFillCutoffUnit = function(unit){};
    /**
     * Returns the unit of the cutoff used for removing NaN valued samples
     * @returns {geotoolkit.util.AbstractUnit} The cutoff unit
     */
    geotoolkit.welllog.Log2DVisual.prototype.getGapFillCutoffUnit = function(){};
    /**
     * Sets the unit of the gap to show discontinuity in sample
     * when the cutoff value is non zero and the unit is convertible to the index unit. If unit is not specified
     * then curve index unit is used. if a depth or time interval is less than specified cutoff value then interval is connected and NaN
     ...
     * @returns {geotoolkit.welllog.Log2DVisual} this
     */
    geotoolkit.welllog.Log2DVisual.prototype.setGapUnit = function(unit){};
    /**
     * Returns the unit of the gap
     * @returns {geotoolkit.util.AbstractUnit} The cutoff unit
     */
    geotoolkit.welllog.Log2DVisual.prototype.getGapUnit = function(){};
    /**
     * Gets the description
     * @returns {?string} The description
     */
    geotoolkit.welllog.Log2DVisual.prototype.getDescription = function(){};
    /**
     * Sets the description
     * @param {?string} description The node description
     * @returns {geotoolkit.welllog.Log2DVisual} this
     */
    geotoolkit.welllog.Log2DVisual.prototype.setDescription = function(description){};
    /**
...
geotoolkit.welllog.StackedTrack = {};
     ...
     * @inheritdoc
     */
    geotoolkit.welllog.StackedTrack.prototype.dispose = function(){};
    /**
     * @override
     * @param {string} event broadcast event
     * @param {geotoolkit.scene.Node} source who is initializing this event
 ...
 * @param {geotoolkit.welllog.LogTrack} track a log track to create header
 * @param {geotoolkit.welllog.header.LogVisualHeaderProvider} [provider] provider of the headers
 * @param {geotoolkit.welllog.TrackFactory} trackFactory the factory that is used to create headers
 */
geotoolkit.welllog.header.StackedTrackHeader = {};
    /**
     * @inheritdoc
     */
    geotoolkit.welllog.header.StackedTrackHeader.prototype.removeVisualHeader = function(){};
    /**
     * @inheritdoc
     */
    geotoolkit.welllog.header.StackedTrackHeader.prototype.updateLayout = function(){};
    /**
     * @inheritdoc
     */
    geotoolkit.welllog.header.StackedTrackHeader.prototype.updateState = function(){};
    /**
     * @inheritdoc
     */
